...
public class BottomTabBar extends LinearLayout {
    ...
    private void init(final List<BarEntity> bars) {
        ...
        LinearLayout.LayoutParams flp = new LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, 1);
        addView(fl, flp);
        /**
         * 添加一根华丽的分割线
         */
        ...
        for (int i = 0; i < bars.size(); i++) {
            ...
            LinearLayout.LayoutParams blp = new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, 1);
